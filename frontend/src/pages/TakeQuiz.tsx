    ...
    <div className="fixed inset-0 z-[100] flex flex-col bg-[#f8f9fb] overflow-y-auto scrollbar-hide">
      ...
      <main className="flex-1 overflow-y-auto scrollbar-hide">
        <div className="mx-auto flex h-full max-w-[1400px] gap-0">
          ...
          <aside className="hidden lg:flex w-[200px] shrink-0 flex-col border-r border-zinc-200 bg-white p-4 overflow-y-auto scrollbar-hide">
            <h3 className="mb-3 text-xs font-bold uppercase tracking-wider text-zinc-400">Questions</h3>
            ...
            <div className="mt-4 space-y-2 border-t border-zinc-100 pt-4">
              <div className="flex items-center gap-2 text-[11px] text-zinc-500">
                <span className="size-2.5 rounded-sm bg-[#2b7fff]" /> Answered ({answeredCount})
              </div>
              <div className="flex items-center gap-2 text-[11px] text-zinc-500">
                <span className="size-2.5 rounded-sm border border-amber-300 bg-amber-100" /> Flagged ({flaggedCount})
              </div>
              <div className="flex items-center gap-2 text-[11px] text-zinc-500">
                <span className="size-2.5 rounded-sm bg-zinc-100" /> Unanswered ({total - answeredCount})
              </div>
            </div>
            ...
            <button
              ...
              className="mt-auto flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-green-600 to-green-700 py-3 text-xs font-bold text-white shadow-lg shadow-green-600/20 transition-all hover:shadow-xl disabled:opacity-50 disabled:shadow-none"
            >
              <Send className="size-3.5" /> {submitting ? "Submitting..." : "Submit Quiz"}
            </button>
          </aside>
